...
(function () {
  ...
  function injectStyles() {
    ...
    s.textContent = `
      ...
      @media(max-width:1250px) and (min-width:861px){.ps-nav{gap:4px!important;padding-inline:8px!important}.ps-brand{flex-basis:132px!important;width:132px!important;height:132px!important}.ps-nav-logo{width:132px!important;height:132px!important}.ps-nav-parent{font-size:10px!important;padding-inline:2px!important;letter-spacing:-.25px!important}.ps-nav-parent-icon{font-size:11px!important}.ps-nav-toggle{width:13px!important;font-size:11px!important}}
      @media(max-width:1050px) and (min-width:861px){.ps-brand{flex-basis:116px!important;width:116px!important;height:116px!important}.ps-nav-logo{width:116px!important;height:116px!important}.ps-nav-parent{font-size:9px!important}}
      @media(max-width:860px){
        .ps-nav{min-height:76px!important;height:76px!important;padding:6px 12px!important}.ps-brand{flex-basis:72px!important;width:72px!important;height:72px!important}.ps-nav-logo{width:72px!important;height:72px!important}.ps-menu{display:block!important;width:46px!important;height:46px!important;margin-left:auto!important;border:1px solid rgba(224,189,85,.25)!important;border-radius:10px!important;background:rgba(224,189,85,.06)!important;padding:9px!important;cursor:pointer!important}.ps-menu span{display:block!important;height:2px!important;margin:5px 2px!important;background:#f1d57b!important}.ps-mainnav{position:absolute!important;left:10px!important;right:10px!important;top:100%!important;display:none!important;flex-direction:column!important;align-items:stretch!important;gap:3px!important;max-height:calc(100vh - 84px)!important;overflow-y:auto!important;padding:8px!important;background:rgba(8,13,20,.995)!important;border:1px solid rgba(224,189,85,.20)!important;border-radius:14px!important;box-shadow:0 18px 45px rgba(0,0,0,.5)!important;white-space:normal!important}.ps-mainnav.is-open{display:flex!important}.ps-nav-group,.ps-nav-parent-row,.ps-nav-home{width:100%!important}.ps-nav-parent{flex:1 1 auto!important;justify-content:flex-start!important;min-height:46px!important;padding:10px 12px!important;font-size:15px!important;letter-spacing:0!important}.ps-nav-toggle{width:46px!important;height:46px!important;font-size:15px!important}.ps-subnav{position:static!important;width:100%!important;max-width:none!important;min-width:0!important;padding:5px 4px 8px 12px!important;margin:0!important;background:rgba(0,0,0,.18)!important;border:0!important;border-radius:0!important;box-shadow:none!important}.ps-nav-group::after{display:none!important}.ps-sub-link{min-height:40px!important;font-size:14px!important}.ps-nav-nested{margin-left:8px!important}body.ps-mobile-nav-open{overflow:hidden!important}.ps-menu[aria-expanded=true] span:nth-child(1){transform:translateY(7px) rotate(45deg)!important}.ps-menu[aria-expanded=true] span:nth-child(2){opacity:0!important}.ps-menu[aria-expanded=true] span:nth-child(3){transform:translateY(-7px) rotate(-45deg)!important}
      }
    `;
  ...
  function init(){injectStyles();ensureFallbackNavigation();ensureFooter();}
