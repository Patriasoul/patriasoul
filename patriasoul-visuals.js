...
(function(){
  ...
  var visuals={
    '/domovina.html':commons.zagreb,'/gradovi.html':commons.zagreb,'/krajevi-i-geografija.html':commons.panonia,'/regionalni-vodic.html':commons.ston,
    '/zagorje-i-prigorje.html':commons.north,'/medimurje.html':commons.north,'/podravina-i-bilogora.html':commons.panonia,'/slavonija-i-baranja.html':commons.panonia,'/posavina-i-pokuplje.html':commons.panonia,
    '/lika-i-gorski-kotar.html':commons.ston,'/istra.html':commons.istra,'/kvarner-i-primorje.html':commons.opatija,'/dalmacija.html':commons.split,'/priroda.html':commons.ston,
    '/povijest.html':commons.north,'/hrvatska-povijest.html':commons.north,'/20-stoljece.html':commons.vukovar,'/stvaranje-moderne-hrvatske.html':commons.vukovar,
    '/bastina.html':commons.istra,'/tradicija-i-obicaji.html':commons.istra,'/glazba.html':commons.istra,'/gastronomija.html':commons.istra,
    '/vukovar.html':commons.vukovar,'/branitelji.html':commons.vukovar,'/domovinski-rat.html':commons.vukovar,'/spomenici.html':commons.memorial,
    '/vjera.html':commons.north,'/hrvatska-i-dijaspora.html':commons.dubrovnik,'/vijesti.html':commons.zagreb
  };
  function css(){if(document.getElementById('ps-visuals-css'))return;var s=document.createElement('style');s.id='ps-visuals-css';s.textContent='.ps-context-photo{max-width:1180px;margin:0 auto 30px;padding:0 20px}.ps-context-photo figure{position:relative;overflow:hidden;margin:0;border-radius:24px;background:#0b1016;border:1px solid rgba(255,255,255,.1);box-shadow:0 18px 55px rgba(0,0,0,.28)}.ps-context-photo img{display:block;width:100%;height:clamp(240px,34vw,430px);object-fit:cover}.ps-context-photo figcaption{position:absolute;left:0;right:0;bottom:0;padding:48px 24px 18px;color:#fff;background:linear-gradient(transparent,rgba(0,0,0,.88))}.ps-context-photo strong{display:block;color:#f1d47d;font-size:clamp(18px,2.3vw,28px);margin-bottom:5px}.ps-context-photo span{font-size:12px;color:#d0d5da}.ps-context-photo a{color:#f1d47d;text-decoration:none}.ps-context-photo small{display:block;margin-top:6px;color:#aeb7c0;font-size:10px}.ps-context-photo .ps-photo-credit{position:absolute;right:12px;bottom:10px;z-index:2;background:rgba(0,0,0,.58);padding:5px 8px;border-radius:8px;color:#fff;font-size:10px}.ps-context-photo .ps-photo-credit a{color:#fff}';document.head.appendChild(s)}
  function render(){var key=location.pathname.replace(/\/+$/,'')||'/';var item=visuals[key];if(!item||document.getElementById('ps-context-photo'))return;var main=document.querySelector('main');if(!main)return;css();var box=document.createElement('section');box.id='ps-context-photo';box.className='ps-context-photo';box.setAttribute('aria-label','Tematska fotografija stranice');box.innerHTML='<figure><img loading="lazy" decoding="async" src="'+item[0]+'" alt="'+item[1]+'"><figcaption><strong>'+item[1]+'</strong><span>Fotografija: '+item[2]+' · '+item[3]+'</span><small><a href="'+item[4]+'" target="_blank" rel="noopener noreferrer">Izvor fotografije i licenca</a></small></figcaption><span class="ps-photo-credit">Wikimedia Commons</span></figure></section>';var hero=main.querySelector('.ps-page-hero');if(hero&&hero.nextSibling)main.insertBefore(box,hero.nextSibling);else main.insertBefore(box,main.firstChild)}
