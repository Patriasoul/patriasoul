...
(function(){
  ...
  window.PatriaQuiz={
    ...
    bank:function(){return window.PATRIA_QUESTIONS||[]},
    ...
    periodQuiz:function(period='daily',count=10){const list=this.seededShuffle(this.bank(),this.periodSeed(period)).slice(0,count);return list.map(q=>this.prepare(q))},
  ...
  document.write('<scr'+'ipt src="js/domovinski.js"></scr'+'ipt>');
  document.write('<scr'+'ipt src="js/question_banks_800.js"></scr'+'ipt>');
  document.write('<scr'+'ipt src="js/povijest_extra.js"></scr'+'ipt>');
...
// Ulazak igrača bez lozinke. Nadimak se na GitHub Pagesu provjerava lokalno.
(function(){
