/* PatriaSoul — canonical portal shell + clean hierarchical navigation */
(function(){'use strict';
var groups=[
...
{label:'Baština',href:'/bastina.html',mega:true,sections:[
...
{label:'Igra',href:'/brani-svoj-grad.html',mega:true,sections:[
