...
function ensureShell(){
 ...
 if(!header){header=document.createElement('header');header.className='ps-header';var c=document.createElement('div');c.className='container ps-nav';header.appendChild(c);var first=document.body.firstElementChild;document.body.insertBefore(header,first||null);}
 var c=header.querySelector('.ps-nav');
 if(!c){c=document.createElement('div');c.className='container ps-nav';while(header.firstChild)c.appendChild(header.firstChild);header.appendChild(c);}
 var nav=c.querySelector('.ps-mainnav');
 if(!nav){nav=document.createElement('nav');nav.className='ps-mainnav';nav.setAttribute('aria-label','Glavna navigacija');c.appendChild(nav);}
 var b=c.querySelector('[data-ps-menu]');
 if(!b){b=document.createElement('button');b.className='ps-menu';b.type='button';b.setAttribute('data-ps-menu','');b.setAttribute('aria-label','Otvori izbornik');b.setAttribute('aria-controls','ps-mainnav');b.setAttribute('aria-expanded','false');b.textContent='☰';c.appendChild(b);}
}
